 ...
 * @author AhmedShalaby
 */
public class API_listAllJobs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            mysql.executeSQLquery_stringRS2(env.getJobsByClass(subclass), 1);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(API_getAllClasses.class.getName()).log(Level.SEVERE, null, ex);
