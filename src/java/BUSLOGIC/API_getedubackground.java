 ...
 * @author AhmedShalaby
 */
public class API_getedubackground extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            mysql.executeSQLquery_stringRS2(env.dq_getedubackground,1);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(API_getedubackground.class.getName()).log(Level.SEVERE, null, ex);
